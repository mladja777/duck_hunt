...
@REM #
ngdbuild -p xc6slx45fgg676-2 -nt timestamp -bm battle_city.bmm "C:/materija/RA46-2015/projekat_v1/duck_hunt/battle_city_design/implementation/battle_city.ngc" -uc battle_city.ucf battle_city.ngd 
